...
The write QPS is around 60. The bottleneck comes from the CPU usage which is always above 90%. The Spanner CPU utilization is around 30%.
...
The write QPS is around 150. The bottleneck comes from the Spanner CPU utilization which is always around 95%. The VM CPU usage is around 50%.
